...
'''训练曲线'''
shoplistfile_split = 'D:/drlTest/UAV-path-planning-main\Multi-UAVs path planning\path planning\MASAC_new' #保存文件数据所在文件的文件名
shoplistfile1 = 'D:/drlTest/UAV-path-planning-main\Multi-UAVs path planning\path planning\MADDPG'  #保存文件数据所在文件的文件名
